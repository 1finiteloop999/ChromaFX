...
Shader "VFX/PandaShaderSampleURPV1.1"
{
	Properties
	{
		...
		[PandaCustomChannel]_MainTexUOffsetC("MainTexUOffsetC", Float) = 1
		[PandaCustomChannel]_MainTexVOffsetC("MainTexVOffsetC", Float) = 1
		[PandaCustomChannel]_VTOScaleC("VTOScaleC", Float) = 1
		[PandaCustomChannel]_DissolveFactorC("DissolveFactorC", Float) = 1
		[PandaCustomChannel]_DistortFactorC("DistortFactorC", Float) = 1
		[PandaCustomChannel]_RefactionFactorC("RefactionFactorC", Float) = 1
